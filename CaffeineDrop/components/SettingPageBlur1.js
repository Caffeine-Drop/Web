...
const SettingPageBlur1 = (props) => (
    <Svg width={`${responsiveWidth(268)}px`} height={`${responsiveHeight(418)}px`} viewBox="0 0 268 418" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <G filter="url(#filter0_f_340_8448)">
            <Circle cx="59" cy="209" r="159" fill="#825A32" fillOpacity="0.08" />
        </G>
        <Defs>
            <Filter id="filter0_f_340_8448" x="-150" y="0" width={`${responsiveWidth(418)}px`} height={`${responsiveHeight(418)}px`} filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
