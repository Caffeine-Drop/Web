    ...
    return (
        <Container>
            <Navbar>
                ...
                {/* 본문 텍스트 */}
                <ContentContainer>
                    <ContentText>개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함. 개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함. 개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함. 개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함. 개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함. 개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함. 개인정보 처리 방침은 추후에 내용이 나오는 대로 추가하도록 함.</ContentText>
                </ContentContainer>
